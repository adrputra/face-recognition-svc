...
type InterfacePermissionService interface {
	GetAllPermissions(e *gin.Context) error
	CreatePermission(e *gin.Context) error
	UpdatePermission(e *gin.Context) error
	AssignRolePermissions(e *gin.Context) error
	GetRolePermissions(e *gin.Context) error
}
...
func (s *PermissionService) GetAllPermissions(e *gin.Context) error {
...
func (s *PermissionService) CreatePermission(e *gin.Context) error {
...
func (s *PermissionService) UpdatePermission(e *gin.Context) error {
...
func (s *PermissionService) AssignRolePermissions(e *gin.Context) error {
...
func (s *PermissionService) GetRolePermissions(e *gin.Context) error {
